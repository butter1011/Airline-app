...
final reviewFeedBackProviderForAirline = StateNotifierProvider<
    ReviewFeedBackForAirlineNotifier, List<Map<String, dynamic>>>((ref) {
  return ReviewFeedBackForAirlineNotifier();
});

class ReviewFeedBackForAirlineNotifier
