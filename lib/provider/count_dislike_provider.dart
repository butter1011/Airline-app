...
//   return CountDislikeNotifier(mainCategoryAndSubcategory);
// });
...
//           // Create a selection list for each aspect based on its subCategory
//           return List.generate(aspect.value['subCategory'].length, (index) => false);
//         }).toList());
...
//   int selectedNumberOfSubcategoryForLike(int aspectIndex) {
//     int selection = 0;
